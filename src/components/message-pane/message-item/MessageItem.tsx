  ...
  return (
    <FileEmbed
      ...
      file={{
        ...
        size: props.attachment.filesize!,
        url: env.RUGIN_CDN + props.attachment.path!,
        previewUrl: env.RUGIN_CDN + props.attachment.path!,
        expireAt: props.attachment.expireAt
      }}
    />
  );
...
const NormalEmbed = (props: {
  ...
  const imageUrl = () =>
    `${env.RUGIN_CDN}proxy/${encodeURIComponent(origSrc()!)}/embed.${
      embed().imageMime?.split("/")[1]
    }`;
