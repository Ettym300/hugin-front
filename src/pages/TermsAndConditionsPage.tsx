      ...
      <Content class="content">
        <CenterContainer>
          <InformationContainer>
            <Title>Rugin Terms and Conditions of Use</Title>
            ...
            <Text opacity={0.6} size={14}>
              ...
              us at{" "}
              <a href="mailto:ruginapp@gmail.com">ruginapp@gmail.com</a>.
            </Text>
          </InformationContainer>
          ...
          <Block title="1. Terms" icon="contract">
            By accessing or using this website (https://rugin.com), you
            ...
            website.{" "}
            <strong>
              Continued access to or use of Rugin following the publication
          ...
          <Block title="2. Age Requirements" icon="cake">
            To use Rugin or any associated services, you must be at least{" "}
          ...
          <Block title="3. Behaviour" icon="sports">
            ...
            doxxing <strong>are prohibited</strong> on Rugin. However, if
            ...
            <div style={{ "margin-top": "15px" }}>
              <strong>
                ...
                absolutely prohibited on Rugin.
              </strong>
            </div>
            <div style={{ "margin-top": "15px" }}>
          ...
          <Block title="4. Servers" icon="storage">
            Creating a server on Rugin that involves exploitation of any game
          ...
          <Block title="5. Links" icon="link">
            Rugin has not reviewed all sites connected to its Website and is
            not responsible for their contents. The presence of any link does
            not imply endorsement by Rugin of the site. Any linked website is
          ...
          <Block title="6. Use Licence" icon="license">
            ...
            <a
              href="https://github.com/orgs/Rugin/repositories"
              target="_blank"
          ...
          <Block title="7. Disclaimer" icon="warning">
            All Rugin's Website materials are provided "as is". Rugin
            makes no promises, expressly or impliedly, therefore negates all
            other warranties. Furthermore, Rugin does not represent the
          ...
          <Block title="8. Limitations" icon="lock">
            Rugin or its suppliers will not be held accountable for any
            damages that arise from the use or inability to use the materials on
            Rugin's Website. This is even if Rugin or an authorised
          ...
          <Block title="9. Revisions and Errata" icon="edit_document">
            Rugin's Website may contain technical, typographical, or
            photographic errors. Rugin does not promise that the materials on
            this Website are accurate, complete, or current. Rugin may change
            its Website materials at any time without notice. Rugin does not
          ...
          <Block title="11. Governing Law" icon="globe_uk">
            Any claim relating to Rugin's Website shall be governed by the
