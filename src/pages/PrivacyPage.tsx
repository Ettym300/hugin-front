      ...
      <Content class="content">
        <CenterContainer>
          <InformationContainer>
            <Title>Rugin Privacy Policy</Title>
            <Text opacity={0.8} size={14}>
              Last updated: 20 February 2026{" "}
              <a
                href="https://github.com/Rugin/rugin-web/commits/main/src/pages/PrivacyPage.tsx"
                target="_blank"
          ...
          <Block title="Data We Store Automatically" icon="storage">
            When registering an account on Rugin and using its services, we
          ...
          <Block title="Data We Collect Automatically" icon="data_usage">
            While using Rugin and its services, we store certain information
          ...
          <Block title="Voice Calling" icon="call">
            Voice calls on Rugin are peer-to-peer, meaning your voice data is
          ...
          <Block title="Data Retention and Deletion" icon="delete">
            You can delete your Rugin account at any time through your
          ...
          <Block title="Your Data Privacy" icon="lock">
            ...
            purposes. Your data is only used to operate and improve Rugin's
            services.
          </Block>
